...
if __name__ == "__main__":
    ...
    parser.add_argument("--results_dir", type=str, default="minecraft_probe_results_final_new2_attack")
    ...
    for candidate in results_candidates:
        ...
        curve_label = candidate.split("_")[-1].split(".")[0]
        curve_label = "Suppressed state" if "original" in curve_label else "Original state"
        ...
        ax.plot(
            layers,
            [layer_stats[metric] * 100 for layer_stats in all_stats.values()],
            marker="o",
