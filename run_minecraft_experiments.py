"""
Script for running experiments/minecraft_experiments_base.py with multiple sets of parameters.
...
Usage:
    python3 run_minecraft_experiments.py --config_file <path_to_config_file>
"""
...
if __name__ == "__main__":
    ...
    parser.add_argument(
        "--config_file",
        type=str,
        default="test_minecraft_experiments_config.json",
        help="Path to JSON config file.",
    )
    parser.add_argument(
        "--log_file",
        type=str,
        default="test_minecraft_experiments_log.json",
    ...
    for param_dict in config_list:
        ...
        for param_tuple in itertools.product(*param_dict.values()):
            ...
            command = "CUDA_VISIBLE_DEVICES={} python3 experiments/minecraft_experiments_base.py {}".format(
                proc_gpu, param_str
            )
